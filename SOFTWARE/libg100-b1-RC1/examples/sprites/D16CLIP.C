...
{ int i,j;
  ...
  do{ temps(100);  // on ralentit un peu le programme
      ...
      d16clip_and(i,j,sprite[2],SEG1); // on pose le masque du sprite sur les 2 buffers
      d16clip_and(i,j,sprite[2],SEG3);
      d16clip_or(i,j,sprite[0],SEG1);  // puis on affiche le sprite sur les 2 buffers
      d16clip_or(i,j,sprite[1],SEG3);}
