...
REM Compilation + Link automatisee par Mastermage version : 1-na
...
ECHO Fichier de sortie: %OUTPUT%.exe
...
ECHO %FLAGS% %OUTPUTFLAG%%OUTPUT%.exe > %RESPONSEFILE%
